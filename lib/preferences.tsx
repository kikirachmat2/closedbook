...
export const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    printWrapReport: "Print Production Wrap Summary",
  },
  id: {
    // Brand & System
    appName: "closedbook.",
    ...
    printWrapReport: "Cetak Ringkasan Wrap Produksi",
  },
  es: {
    // Brand & System
    appName: "closedbook.",
    ...
    printWrapReport: "Imprimir resumen final de producción",
  },
  ja: {
    // Brand & System
    appName: "closedbook.",
    ...
    printWrapReport: "日次プロダクション完了サマリーを印刷",
  },
};
