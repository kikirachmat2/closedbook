...
export const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    demoBannerTitle: "Sample Production Project",
    demoBannerDesc: "You're exploring sample data for 'The Quiet Horizon'. Explore features or create your own project to start fresh.",
    createMyProject: "Create My Project",
    noExpensesYet: "No Expenses Recorded Yet",
    noExpensesYetDesc: "Track production petty cash, vendor purchases, and physical receipt scans here.",
    logFirstExpense: "Log First Expense",
    noMatchingTransactions: "No Matching Transactions",
    noMatchingTransactionsDesc: "No records match your search query or selected department filter.",
    resetFilters: "Reset Filters",
    noTasksInColumn: "No tasks in this column",
    addTask: "Add Task",
    noEquipmentYet: "No Rental Gear Logged",
    noEquipmentYetDesc: "Monitor daily rental burn rates, camera packages, and return deadlines.",
    addEquipment: "Add Rental Gear",
    allClearTitle: "All Systems Clear",
    allClearDesc: "No active anomalies, overdrafts, or overdue tasks detected. Production financial state is optimal.",
    allClearBadge: "Audit Status: Optimal",
    noTransfersYet: "No Pocket Transfers Recorded",
    noTransfersYetDesc: "Move liquid cash between Master Vault and Department Pockets to fund shoot operations.",
  ...
  id: {
    ...
    downloadBackup: "Download Backup JSON",
    demoBannerTitle: "Proyek Demo Produksi",
    demoBannerDesc: "Anda sedang melihat data contoh 'The Quiet Horizon'. Jelajahi fitur atau buat proyek baru untuk memulai pembukuan tim Anda.",
    createMyProject: "Buat Proyek Saya",
    noExpensesYet: "Belum Ada Pengeluaran Tercatat",
    noExpensesYetDesc: "Catat petty cash produksi, belanja vendor, dan foto struk di sini.",
    logFirstExpense: "Catat Pengeluaran Pertama",
    noMatchingTransactions: "Tidak Ada Transaksi yang Cocok",
    noMatchingTransactionsDesc: "Tidak ada transaksi yang cocok dengan kata kunci atau filter departemen ini.",
    resetFilters: "Reset Filter",
    noTasksInColumn: "Tidak ada tugas di kolom ini",
    addTask: "Tambah Tugas",
    noEquipmentYet: "Belum Ada Alat Sewa Tercatat",
    noEquipmentYetDesc: "Pantau burn rate sewa harian, paket kamera, dan batas waktu pengembalian.",
    addEquipment: "Tambah Alat Sewa",
    allClearTitle: "Semua Sistem Terkendali",
    allClearDesc: "Tidak ada anomali anggaran, pengeluaran berlebih, atau tugas tertunda. Keuangan produksi optimal.",
    allClearBadge: "Status Audit: Optimal",
    noTransfersYet: "Belum Ada Riwayat Transfer",
    noTransfersYetDesc: "Pindahkan dana dari Master Vault ke Pocket Departemen untuk kebutuhan operasional.",
  ...
  es: {
    ...
    demoBannerTitle: "Proyecto de Demostración",
    demoBannerDesc: "Estás explorando datos de muestra de 'The Quiet Horizon'. Explora las funciones o crea tu propio proyecto.",
    createMyProject: "Crear Mi Proyecto",
    noExpensesYet: "Sin gastos registrados aún",
    noExpensesYetDesc: "Registra caja chica de producción, compras a proveedores y recibos aquí.",
    logFirstExpense: "Registrar Primer Gasto",
    noMatchingTransactions: "No se encontraron transacciones",
    noMatchingTransactionsDesc: "Ningún registro coincide con tu búsqueda o filtro seleccionado.",
    resetFilters: "Restablecer Filtros",
    noTasksInColumn: "Sin tareas en esta columna",
    addTask: "Agregar Tarea",
    noEquipmentYet: "Sin equipo de alquiler registrado",
    noEquipmentYetDesc: "Monitorea tarifas de alquiler diarias, paquetes de cámara y fechas de devolución.",
    addEquipment: "Agregar Equipo de Alquiler",
    allClearTitle: "Todos los Sistemas en Orden",
    allClearDesc: "No se detectaron anomalías, sobregiros ni tareas vencidas. El estado financiero es óptimo.",
    allClearBadge: "Estado de Auditoría: Óptimo",
    noTransfersYet: "Sin transferencias de fondo registradas",
    noTransfersYetDesc: "Mueve fondos entre la Bóveda Principal y los Bolsillos para financiar el rodaje.",
  ...
  ja: {
    ...
    demoBannerTitle: "サンプル制作プロジェクト",
    demoBannerDesc: "「The Quiet Horizon」のサンプルデータを表示しています。機能を探索するか、独自のプロジェクトを作成してください。",
    createMyProject: "新規プロジェクト作成",
    noExpensesYet: "記録された経費はまだありません",
    noExpensesYetDesc: "現場小口現金、備品購入、領収書スキャンをここで管理します。",
    logFirstExpense: "最初の経費を記録",
    noMatchingTransactions: "一致する取引が見つかりません",
    noMatchingTransactionsDesc: "検索条件または選択された部門フィルターに一致する記録がありません。",
    resetFilters: "フィルターをリセット",
    noTasksInColumn: "このカラムにタスクはありません",
    addTask: "タスクを追加",
    noEquipmentYet: "登録されたレンタル機材はありません",
    noEquipmentYetDesc: "日次レンタル費用、カメラパッケージ、返却期限を追跡します。",
    addEquipment: "レンタル機材を追加",
    allClearTitle: "全システム正常",
    allClearDesc: "予算異常、超過、期限切れタスクは検出されていません。制作財務状態は良好です。",
    allClearBadge: "監査ステータス: 最適",
    noTransfersYet: "ポケット間振替の記録はありません",
    noTransfersYetDesc: "マスター保管庫から各部門ポケットへ資金を配分します。",
