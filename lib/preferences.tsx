...
export const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  ...
  ja: {
    ...
    tabPockets: "資金ポケット階層",
    tabTasks: "チームタスク",
    tabCallSheet: "プロジェクト日程・スケジュール",
    tabEquipment: "機材・レンタル",
    tabAlerts: "自動アラート",
    tabSheet: "Googleスプレッドシート",

    // Executive Overview
    totalBudget: "総プロジェクト予算",
    budgetCommitted: "100% 割当済み",
    disbursedToDepts: "カテゴリ別出金総額",
    burnRate: "予算消化率",
    fieldCashOnHand: "現場手許現金",
    cashSufficient: "プロジェクト日充足",
    activeAlerts: "アクティブ警告",
    auditRequired: "監査が必要です",
    deptBudgetRealization: "カテゴリ別予算執行状況",
    deptBudgetSub: "カテゴリ予算上限に対するリアルタイム支出推移",
    recentEntries: "最近の小口現金支出",
    viewAllLedger: "出納帳をすべて表示",
    activeFlags: "プロジェクト警告",
    resolve: "解決",
    resolved: "解決済み",
    ...
    searchPlaceholder: "取引先、カテゴリ、品目、TX番号で検索...",
    filterAll: "すべての項目",
    filterApproved: "承認済み",
    filterPending: "承認待ち",
    filterMissing: "領収書紛失",
    ...
    pocketsSub: "マスター保管庫から現場チームまでの漏れなき資金出金",
    ...
    // Call Sheet -> Schedule
    callSheetTitle: "プロジェクト日程・日次ブリーフィング",
    callSheetSub: "本日の予定、マイルストーン、開始時間、緊急連絡先",
    callTime: "開始時間 / Call",
    estimatedWrap: "終了予定 (Close-out)",
    location: "実施場所 / ロケーション",
    weather: "天候",
    ...
    formMissingReceiptCheck: "領収書紛失フラグ（リーダー承認が必要）",
    ...
    // Landing Page
    landingHeroEyebrow: "プロジェクト・業務運営OS",
    landingHeroHeadline: "Googleインフラの上でプロジェクトを動かす。",
    ...
    advanceDay: "プロジェクト日を進める",
    editCallSheet: "日程ブリーフィング編集",
